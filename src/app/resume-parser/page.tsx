...
const RESUME_EXAMPLES = [
  {
    ...
    description: (
      <span>
        Created with CareerCraft resume builder -{" "}
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            ...
            <Paragraph smallMarginTop={true}>
              This playground showcases the CareerCraft CV parser and its
              ability to parse information from a CV PDF. This helps you understand
              how well your CV will be read by South African employers' ATS systems.
            </Paragraph>
            ...
            <Paragraph>
              You can also{" "}
              <span className="font-semibold">add your CV below</span> to
              assess how well your CV would be parsed by Application
              Tracking Systems (ATS) commonly used by South African employers and recruiters.
              The more information it can parse out, the better it indicates your CV
