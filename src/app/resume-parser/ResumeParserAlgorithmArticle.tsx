  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the ZA-Resume
      ...
      <Paragraph>
        And that is everything about the ZA-Resume parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by Thabo Jafta on August 2025
      </Paragraph>
    </article>
  );
};
