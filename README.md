...
CareerCraft is a powerful open-source resume builder and resume parser.

The goal of CareerCraft is to provide everyone with free access to a modern professional resume design and enable anyone to apply for jobs with confidence.

Official site: [https://careercraft.com](https://careercraft.com)
...
| **2. Modern Professional Resume Design** | The resume PDF is a modern professional design that adheres to South African best practices and is ATS friendly to top ATS platforms such as Greenhouse and Lever. It automatically formats fonts, sizes, margins, bullet points to ensure consistency and avoid human errors. |
...
| **5. Successful Track Record** | CareerCraft users have landed interviews and offers from top companies, such as Takealot, Capitec, Discovery, and Naspers to name a few. It has been proven to work and liken by recruiters and hiring managers. |
...
CareerCraft is created with the NextJS web framework and follows its project structure. The source code can be found in `src/app`. There are a total of 4 page routes as shown in the table below. (Code path is relative to `src/app`)
